...
class MetadataHandler:
    """
    A class used to handle metadata operations.

    ...

    Methods
    -------
    load_metadata(content: str) -> DataFrame | None
        Loads codebook from API and returns a DataFrame or None.
    """
    ...
    def create_raw_label_map(metadata: DataFrame) -> dict:
        """Create a mapping dictionary for raw values to labels."""
